...
public class AddTeachers extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] items  = new String[]{"Select Category","Computer Science","Accounts","Management","Head of Department","Staff","Lecturer","TECHNOLOGY AND MANAGEMENT","Principal"};
    ...
    private void checkValidation() {
        ...
        if (name.isEmpty()){
            ...
            Toast.makeText(this, "Please provide faculty designation!", Toast.LENGTH_SHORT).show();
        }else if (bitmap ==  null){
                        insertData();
        }else {
            insertImage();
    ...
    private void insertData() {
        ...
        dbRef.child(name + uniqueKey).setValue(teacherData).addOnSuccessListener(new OnSuccessListener<Void>() {
                @Override
                public void onSuccess(Void unused) {
                    pd.dismiss();
                    Toast.makeText(AddTeachers.this, "Faculty added", Toast.LENGTH_LONG).show();
                    finish();
                }
                ...
                public void onFailure(@NonNull Exception e) {
                    pd.dismiss();
                    Toast.makeText(AddTeachers.this, "Something went wrong in insert Data!", Toast.LENGTH_SHORT).show();
                }
            });
        }
