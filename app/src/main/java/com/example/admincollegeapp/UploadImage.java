        ...
        uploadTask.addOnCompleteListener(UploadImage.this, new OnCompleteListener<UploadTask.TaskSnapshot>() {
            ...
            public void onComplete(@NonNull Task<UploadTask.TaskSnapshot> task) {
                if (task.isSuccessful()){
                    ...
                    pd.dismiss();
                    Toast.makeText(UploadImage.this, "Something went wrong in Upload image!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void uploadData() {
        ...
        dbRef.child(uniqueKey).setValue(downloadUrl).addOnSuccessListener(new OnSuccessListener<Void>() {
            ...
            public void onSuccess(Void unused) {
                pd.dismiss();
                Toast.makeText(UploadImage.this, "data uploaded successfully", Toast.LENGTH_SHORT).show();
               // finish();
            }
            ...
            public void onFailure(@NonNull Exception e) {
                pd.dismiss();
                Toast.makeText(UploadImage.this, "Something went wrong uploadingData!", Toast.LENGTH_SHORT).show();
            }
        });
    }
